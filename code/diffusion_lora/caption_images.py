"""Auto-caption every image in data/diffusion_lora/train/ with BLIP, prepend a trigger
word, and write metadata.jsonl in the format the diffusers LoRA trainer expects.

Output: data/diffusion_lora/train/metadata.jsonl with one line per image:
