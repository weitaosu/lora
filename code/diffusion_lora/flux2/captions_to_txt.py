"""Convert data/diffusion_lora/train/metadata.jsonl (HF datasets format) into per-image
sidecar .txt files (the format ai-toolkit expects).

Before:
    data/diffusion_lora/train/img1.jpg
    data/diffusion_lora/train/metadata.jsonl    # {"file_name":"img1.jpg","text":"wbronkhorst style, ..."}

After:
    data/diffusion_lora/train/img1.jpg
    data/diffusion_lora/train/img1.txt          # "wbronkhorst style, ..."
