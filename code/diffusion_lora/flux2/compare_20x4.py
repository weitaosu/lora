...
RESULTS_BASE = ROOT / 'results' / 'diffusion_lora'
OUT = RESULTS_BASE / 'flux2_20x4_compare.png'

VERSIONS = [
    ('Baseline (Flux.2 Klein 9B)', 'inference_baseline'),
    ('WB LoRA v1 @ step 3000',     'inference_v1'),
    ('WB LoRA v2 @ step 5000',     'inference_v2'),
    ('WB LoRA v3 @ step 5000',     'inference_v3'),
]
