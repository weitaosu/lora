...
Usage:
    # baseline (no LoRA), saves to results/diffusion_lora/baseline/
    python generate.py --no-lora

    # with trained LoRA, saves to results/diffusion_lora/lora/
...
DEFAULT_OUT = ROOT / 'results' / 'diffusion_lora'
...
def main():
    ...
    grp.add_argument('--lora', type=str, default=None,
                     help='path to trained LoRA weights dir (e.g. ../../../models/diffusion_lora/flux1)')
    ...
    ap.add_argument('--out', default=None,
                    help='output dir (default: results/diffusion_lora/{baseline|lora})')
