"""Launch ai-toolkit training using wb_lora_flux2.yaml.

This is a thin wrapper around `python <ai-toolkit>/run.py wb_lora_flux2.yaml`
...
DEFAULT_CONFIG = HERE / 'wb_lora_flux2.yaml'
