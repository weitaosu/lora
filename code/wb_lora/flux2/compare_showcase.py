...
RESULTS = ROOT / 'results' / 'wb_lora_compare'
...
VERSION_DIRS = {
    'baseline': RESULTS / 'wb_lora_flux2_inference_baseline' / 'samples',
    'v1':       RESULTS / 'wb_lora_flux2_inference_v1' / 'samples',
    'v2':       RESULTS / 'wb_lora_flux2_inference_v2' / 'samples',
    'v3':       RESULTS / 'wb_lora_flux2_inference_v3' / 'samples',
}
