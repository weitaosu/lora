...
MODELS = ROOT / 'models' / 'wb_lora_flux2'
OUT = ROOT / 'results' / 'wb_lora_compare' / 'flux2_v1_v2_v3_3way.png'

VERSIONS = [
    ('v1 baseline (step 3000)', MODELS / 'wb_lora_flux2_klein_9b' / 'samples', 3000),
    ('v2 (step 5000)', MODELS / 'wb_lora_flux2_klein_9b_v2' / 'samples', 5000),
    ('v3 (step 5000)', MODELS / 'wb_lora_flux2_klein_9b_v3' / 'samples', 5000),
]
