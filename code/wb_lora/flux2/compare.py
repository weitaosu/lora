...
ai-toolkit writes sample images during training to:
    models/wb_lora_flux2/<run_name>/samples/<step>/<prompt_idx>_<img_idx>.png
...
DEFAULT_RUN_DIR = ROOT / 'models' / 'wb_lora_flux2'
DEFAULT_OUT = ROOT / 'results' / 'wb_lora_compare' / 'flux2_grid.png'
