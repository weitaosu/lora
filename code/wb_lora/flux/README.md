...
The captioning script lives one level up at `code/wb_lora/caption_images.py`. Run it once if you haven't:
```bash
cd c:/Users/weita/Desktop/deep_learning/final_proj/code/wb_lora
python caption_images.py
# writes data/wb_lora_train/metadata.jsonl
```
...
```bash
cd c:/Users/weita/Desktop/deep_learning/final_proj/code/wb_lora/flux
...
# -> results/wb_lora_compare/baseline/00_00__....png  (8 images)
```
...
Output: `models/wb_lora_flux/pytorch_lora_weights.safetensors`
Intermediate checkpoints every 500 steps in `models/wb_lora_flux/checkpoint-N/`.
...
# -> results/wb_lora_compare/lora/00_00__....png  (8 images, matching filenames)
```

Tune the LoRA strength at gen time:
```bash
python generate.py --lora ../../../models/wb_lora_flux --lora-scale 0.7   # softer
python generate.py --lora ../../../models/wb_lora_flux --lora-scale 1.2   # stronger
```
...
```bash
python compare.py
# -> results/wb_lora_compare/grid.png
```
...
#   c:/Users/weita/Desktop/deep_learning/final_proj/data/wb_lora_train
