...
Reads images from results/wb_lora_compare/baseline/ and results/wb_lora_compare/lora/
...
DEFAULT_BASE = ROOT.parent / 'results' / 'wb_lora_compare' / 'baseline' if False else None

# Use absolute path the simple way
ROOT = Path(__file__).resolve().parent.parent.parent       # final_proj/
DEFAULT_BASELINE = ROOT / 'results' / 'wb_lora_compare' / 'baseline'
DEFAULT_LORA     = ROOT / 'results' / 'wb_lora_compare' / 'lora'
DEFAULT_OUT      = ROOT / 'results' / 'wb_lora_compare' / 'grid.png'
